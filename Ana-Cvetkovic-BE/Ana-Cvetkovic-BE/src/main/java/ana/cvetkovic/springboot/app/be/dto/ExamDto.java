...
public class ExamDto implements MyDto {
	...
	private List<StudentExamDto> students = new ArrayList<>();
	
	public ExamDto() {
		
	}

	public ExamDto(Long id, ExamPeriodDto examPeriod, SubjectDto subject, Date examDate, ProfessorDto professor) {
		super();
	...
	public String toString() {
		return "ExamDto [id=" + id + ", examPeriod=" + examPeriod + ", subject=" + subject + ", professor=" + professor
				+ ", examDate=" + examDate + ", students=" + students + "]";
	}
