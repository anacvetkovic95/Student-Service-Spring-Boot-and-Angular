...
public class SimpleStudentDto {
	...
	public SimpleStudentDto(Long id, String indexNumber, Integer indexYear, String firstName, String lastName,
			String email, String adress, CityDto city, Integer currentYearOfStudy) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SimpleStudentDto other = (SimpleStudentDto) obj;
		if (adress == null) {
	...
	public String toString() {
		return "SimpleStudentDto [id=" + id + ", indexNumber=" + indexNumber + ", indexYear=" + indexYear
				+ ", firstName=" + firstName + ", lastName=" + lastName + ", email=" + email + ", adress=" + adress
				+ ", city=" + city + ", currentYearOfStudy=" + currentYearOfStudy + "]";
	}
